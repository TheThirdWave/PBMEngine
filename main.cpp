...
*/
    ...
    edge[1].setID(EDGE);
    edge[1].addChild(&part[8]);
    edge[1].addChild(&part[9]);
    edge[1].setSpring(2.0, 0.001, 0.00005);
    part[1].addParent((PhysicsObject*)&edge[0]);
    part[0].addParent((PhysicsObject*)&edge[0]);
    edge[0].addToManager((void*)&physicsManager);
    edge[0].setID(EDGE);
