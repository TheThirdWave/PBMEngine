...
void KeyHandler(unsigned char key, int x, int y)
{
    ...
    case 'z':
    {
        ...
        else
        {
            ...
            hold.setPoint(glm::vec3(120.0f, -200.0f, -10.0f));
            ...
            hold8.setColor(glm::vec4(1000.0f, 1000.0f, 1000.0f, 1000.0f), glm::vec4(100.0f, 0.0f, 0.0f, 100.0f), glm::vec4(0.0f, 50000.0f, 5000.0f, 5000.0f));
            ...
            AreaLight light4;
            light4.initialize(glm::vec3(-0.0f, -300.0f, 300.0f), glm::normalize(glm::vec3(0.0f, 0.3f, -0.3f)), glm::vec3(0.0f, 1.0f, 0.0f), 100, 100, 1);
            ...
            Screen.draw3DFocus(glm::vec3(000.0f, -200.0f, 400.0f), 500.0f, 800.0f,  glm::vec3(0.0f, 1.0f, 0.0f), glm::normalize(glm::vec3(-0.0f, 0.0f, -0.7f)), (float)Screen.getHeight(), 0.0f, 8);
